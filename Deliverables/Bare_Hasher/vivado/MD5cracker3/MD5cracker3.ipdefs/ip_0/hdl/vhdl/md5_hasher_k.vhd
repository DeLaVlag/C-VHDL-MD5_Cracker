...
architecture rtl of md5_hasher_k_rom is 
...
architecture arch of md5_hasher_k is
    component md5_hasher_k_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    md5_hasher_k_rom_U :  component md5_hasher_k_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
